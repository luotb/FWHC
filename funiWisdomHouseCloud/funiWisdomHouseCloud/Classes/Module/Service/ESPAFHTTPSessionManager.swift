...
class ESPAFHTTPSessionManager: AFHTTPSessionManager {
    ...
    func ESP_PUT(URLString: String!, parameters: [NSObject: AnyObject]!, taskSuccessed: (responseVO:BaseRespDomain)->Void, taskFailured: (error:String)->Void ){
    ...
    func ESP_POST(URLString: String!, parameters: [NSObject: AnyObject]!, taskSuccessed: (responseVO:BaseRespDomain)->Void, taskFailured: (error:String)->Void ){
    ...
    func ESP_GET(URLString: String!, parameters: [NSObject: AnyObject]!, taskSuccessed: (responseVO:BaseRespDomain)->Void, taskFailured: (error:String)->Void ){
